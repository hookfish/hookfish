...
| Package | Use it for |
| --- | --- |
| `hookfish` | CLI, backend scaffolding, migrations, and MCP inspector |
| `@hookfish/client` | Mountable Hono facade for the separate operator frontend |
...
| `@hookfish/backend` | Lower-level raw API and application-facade composition |
