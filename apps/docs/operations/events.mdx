...
refresh flag, replay flag, application subject, or resolved base path depending
on the operation. They do not include access tokens, refresh tokens, client
secrets, or stored secret values.
