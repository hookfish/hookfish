...
Events can include a provider ID, connection path, token name, secret path,
error code, refresh flag, or replay flag depending on the operation. They do
not include access tokens, refresh tokens, client secrets, or vault values.
