/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config ./wrangler.jsonc --env-file ../server/.env.example --strict-vars false` (hash: e524662f1d66ed05de5135dfa32da6b6)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BASE_URL" | "OAUTH_ENCRYPTION_KEY" | "BROKER_API_KEY" | "NOTION_CLIENT_ID" | "NOTION_CLIENT_SECRET">> {}
}
